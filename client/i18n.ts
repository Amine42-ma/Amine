...
const STRINGS: Dict = {
  ...
  openDeals: ['العقود المفتوحة', 'Open contracts'],
  noDeals: ['لا توجد عقود مفتوحة. اعرض صفقة وكن أول من يتاجر مباشرة.',
            'No open contracts. Post one and be the first to deal direct.'],
  forSale: ['للبيع', 'For sale'],
  wanted: ['مطلوب', 'Wanted'],
  yours: ['لك', 'Yours'],
  unit: ['وحدة', 'unit'],
  accept: ['قبول', 'Accept'],
  dealSide: ['نوع الصفقة', 'Deal type'],
  iAmSelling: ['أبيع', 'I am selling'],
  iAmBuying: ['أشتري', 'I am buying'],
  totalPrice: ['السعر الإجمالي', 'Total price'],
  postDeal: ['انشر العقد', 'Post contract'],
  escrowNote: [
    'يُحتجز ما تعرضه (بضاعة أو ذهب) كضمان حتى يقبل تاجر آخر أو تلغي العقد.',
    'Whatever you put up — goods or gold — is held in escrow until someone accepts or you cancel.',
  ],
  alliances: ['التحالفات', 'Alliances'],
  allianceName: ['اسم التحالف', 'Alliance name'],
  foundAlliance: ['تأسيس', 'Found'],
  joinAlliance: ['انضمام', 'Join'],
  leaveAlliance: ['مغادرة', 'Leave'],
  yourAlliance: ['تحالفك', 'Your alliance'],
  members: ['عضو', 'members'],
